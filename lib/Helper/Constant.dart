final String appName = 'Nippy Seller';

final String packageName = 'com.nippy';

final String iosPackage = 'com.nippy';
// https://alphawizztest.tk/Food_on_the_way/app/v1/api/
// final String baseUrl = 'https://foodontheways.com/seller/app/v1/api/';
final String baseUrl = 'https://nippy.ind.in/seller/app/v1/api/';
