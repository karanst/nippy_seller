...
Future<void> saveUserDetail(
  ...
  waitList.add(prefs.setString(REFER, referral));
  waitList.add(prefs.setString(SELFIE, selfieImage ?? ''));
  waitList.add(prefs.setString(PAN, panImage ?? ''));
  waitList.add(prefs.setString(ADHAR, adharImage ?? ''));
  waitList.add(prefs.setString(FSSAI, fssaiImage ?? ''));
  waitList.add(prefs.setString(GST, gstImage ?? ''));
