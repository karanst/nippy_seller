...
const String ReferralCode = 'referral_code';
const String PanCard = 'national_identity_card';
const String AdharCard = 'address_proof';
const String Gst = 'gst_file';
const String    Fssai = 'fssai';
const String Selfie = 'image';
