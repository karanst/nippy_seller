...
//================= User Details frome Shared Preferance =======================
  ...
  getUserDetails() async {
    ...
    gstImage = await getPrefrence(GST);
    fssaiImage = await getPrefrence(FSSAI);
    panCardImage = await getPrefrence(PAN);
    adharCardImage = await getPrefrence(ADHAR);
    selfieImage = await getPrefrence(SELFIE);
    mobileC!.text = mobile ?? "";
    nameC!.text = name ?? "";
    emailC!.text = email ?? "";
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                      image: DecorationImage(
                          image: NetworkImage(panCardImage?? ''),
                          fit: BoxFit.cover),),)
                    : Container(
                  height: 50,
                  width: 90,
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  getTranslated(context, "AdharNumber")!,
                  style: Theme.of(this.context).textTheme.caption!.copyWith(
                      color: lightBlack2, fontWeight: FontWeight.normal),
                ),
                imageadhar== null
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                    image: DecorationImage(
                        image: NetworkImage(adharCardImage?? ''),
                        fit: BoxFit.cover),),)
                    : Container(
                  height: 50,
                  width: 90,
