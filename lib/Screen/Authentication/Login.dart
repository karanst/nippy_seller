...
import 'package:eshopmultivendor/Screen/Authentication/signup.dart';
    ...
    apiBaseHelper.postAPICall(getUserLoginApi, data).then(
        ...
        if (!error) {
         // Fluttertoast.showToast(msg: 'msg');
          ...
          print("_______${getdata["data"][0]['referral_code']}_______");
          id = data[Id];
          referral = data[ReferralCode];
          panCardImage = data[PanCard];
          adharCardImage = data[AdharCard];
          gstImage = data[Gst];
          fssaiImage = data[Fssai];
