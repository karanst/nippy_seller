...
import 'package:eshopmultivendor/Screen/refer_earn.dart';
      ...
      apiBaseHelper.postAPICall(getSellerDetails, parameter).then(
        (getdata) async {
          ...
          if (!error) {
            ...
            NO_OFF_RATTING = data[NoOfRatings] ?? "";
            var id = data[Id];
            var referral = data[ReferralCode];
            ...
            var gstImage = data[Gst];
          var fssaiImage =data[Fssai];
          var selfieImage =data[Selfie];
          var panCardImage =data[PanCard];
          var adharCardImage =data[AdharCard];
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              _getDrawerItem(
                  13, 'Refer and Earn', Icons.contact_page),
              Divider(),
              _getDrawerItem(
